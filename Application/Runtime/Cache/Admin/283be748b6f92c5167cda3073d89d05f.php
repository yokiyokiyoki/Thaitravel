...
<body>
  ...
  <div class="route_bg">
            <span>&nbsp;国家公园&nbsp;->&nbsp;修改</span>
            <a href="/ThaiTravel/index.php/Admin/Type3/showlist3" style="float:right;margin:0px 10px 0px 0px;">返回</a> &nbsp;&nbsp;
        </div>
...
<table class="table table-bordered">
   <thead>
     <tr>
       ...
       <td>公园名称</td>
       <td colspan="2"><input type="text" name="gdname" value="<?php echo ($gdname); ?>" /></td>
   ...
   <tbody>
     <tr>
       <td>英文名称</td>
       <td colspan="2"><input type="text" name="en_name" value= "<?php echo ($en_name); ?>" /></td>
    ...
    <tr>
       ...
       <td>内容</td>
       <td colspan="2"><textarea name="content"  id="" cols="60" rows="10"><?php echo ($content); ?></textarea></td>
