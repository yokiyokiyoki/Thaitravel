...
<body>
        ...
        <div class="route_bg">
            <span>&nbsp;国家公园&nbsp;->&nbsp;国家公园管理</span>
            <a href="/ThaiTravel/index.php/Admin/Type3/tianjia3" style="float:right;margin:0px 10px 0px 0px;">添加</a> &nbsp;&nbsp;
...
<table class="table table-striped table-bordered table-hover">
   ...
   <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
       ...
       <td><a href="/ThaiTravel/index.php/Admin/Type3/shanchu3/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('您确定要删除这个栏目吗？')">删除</a></td>
       <td><a href="/ThaiTravel/index.php/Admin/Type3/xiugai3/id/<?php echo ($vo["id"]); ?>">更改</a></td>
